<?php
//prende e stampa dal dtb le corse attive di tutti gli utenti
...
$sqlGetUtente = "SELECT corsa.*, utente.email FROM utente,corsa WHERE utente.id_utente = corsa.id_utente ORDER BY corsa.data_inizio";
...
foreach ($risUtente as $rigaGetUtente) {
    ...
    $output = '
            <div class="row">
                ...
                <div class="col-md-3">
                    <p class="form-check-label "><b>Cliente</b></p>
                    <p>' . $rigaGetUtente["email"] . '</p>
                </div>
                <div class="col-md-3">
